...
class ShowIdeasTest extends TestCase
{
    ...
    public function list_of_ideas_shows_on_main_page()
    {
        ...
        $response->assertSee('<div class="px-4 py-2 font-bold leading-none text-center uppercase bg-purple text-white rounded-full text-xxs w-28 h-7">Considering</div>', false);
    }
