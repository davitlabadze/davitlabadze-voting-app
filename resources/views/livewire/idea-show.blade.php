            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                            ...
                            <ul
                                ...
                                @can('update', $idea)
                                    <li><a href="#"
                                        ...
                                        class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Edit Idea</a>
                                    </li>
                                @endcan
                                ...
                                @can('delete', $idea)
                                    <li>
                                        ...
                                        class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete Idea</a>
                                    </li>
                                @endcan
                    ...
                    <div class="flex items-center md:hidden mt-4 md:mt-0">
                        ...
                        @if ($hasVoted)
                        <button wire:click.prevent="vote" class="w-20 bg-blue text-white border border-blue font-bold text-xxs uppercase rounded-xl hover:bg-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5">
                            Voted
                        </button>
                        @else
                        <button wire:click.prevent="vote" class="w-20 bg-gray-200 border border-gray-200 font-bold text-xxs uppercase rounded-xl hover:border-gray-400 transition duration-150 ease-in px-4 py-3 -mx-5">
                            Vote
                        </button>
                        @endif
                    </div>
